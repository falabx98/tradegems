...
import { generateChartPath, getPriceAtTime } from './chartGenerator';
import { generateNodes } from './nodeGenerator';
import {
  EngineConfig,
...
import type { SimulationContext } from './engineConfig';
...
export function simulateRound(
  ...
  const engineConfig = config.engineConfig ?? DEFAULT_ENGINE_CONFIG;
